...
export const STAGES = [
  ...
  { id: 'graph', n: 4, title: '建立關聯', subtitle: '把物件連成圖', blurb: '解析完才畫得出來的那張圖。' },
  { id: 'simulate', n: 5, title: '約束傳播', subtitle: '資源是有限的', blurb: '每個數字都是算出來的，不是寫死的。' },
  { id: 'act', n: 6, title: '動作與寫回', subtitle: '把決策送回現實', blurb: '權限、衝突、部分失敗、稽核。' },
  { id: 'debrief', n: 7, title: '總結對照', subtitle: '兩份資料集並排看', blurb: '同一條流水線，兩種世界。' },
];
